                    ...
                    <ul className="menu">
                      <li>{/* start message */}
                        <Link to="#">
                          <div className="pull-left">
                            <img
                              src="/AdminLTE/dist/img/user2-160x160.jpg" className="img-circle"
                              alt="User"
                            />
                          </div>
                          <h4>
                      ...
                      <li>
                        <Link to="#">
                          <div className="pull-left">
                            <img
                              src="/AdminLTE/dist/img/user3-128x128.jpg" className="img-circle"
                              alt="User"
                            />
                          </div>
                          <h4>
                      ...
                      <li>
                        <Link to="#">
                          <div className="pull-left">
                            <img
                              src="/AdminLTE/dist/img/user4-128x128.jpg" className="img-circle"
                              alt="User"
                            />
                          </div>
                          <h4>
                ...
                <ul className="dropdown-menu">
                  ...
                  <li>
                    ...
                    <ul className="menu">
                      ...
                      <li>
                        <Link to="#">
                          <i className="fa fa-warning text-yellow" /> Very long description here
                          that
