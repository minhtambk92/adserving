  ...
  return (
    <aside className="control-sidebar control-sidebar-dark">
      ...
      <ul className="nav nav-tabs nav-justified control-sidebar-tabs">
        <li><Link to="#control-sidebar-home-tab" data-toggle="tab"><i
          className="fa fa-home"/></Link></li>
        <li><Link to="#control-sidebar-settings-tab" data-toggle="tab"><i className="fa fa-gears"/></Link>
        </li>
      </ul>
      {/* Tab panes */}
        ...
        <div className="tab-pane" id="control-sidebar-settings-tab">
          <form method="post">
            ...
            <div className="form-group">
              <label className="control-sidebar-subheading">
                Delete chat history
                <Link to="javascript:void(0)" className="text-red pull-right"><i
                  className="fa fa-trash-o"/></Link>
              </label>
            </div>
            {/* /.form-group */}
          </form>
...
export default withStyles(s)(AsideRight);
