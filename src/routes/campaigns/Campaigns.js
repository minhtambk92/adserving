            ...
            <section className="col-lg-12">
              ...
              <div className="box box-info">
                ...
                <div className="box-footer clearfix">
                  <button className="btn btn-sm btn-info btn-flat pull-left">Place New Order</button>
                  <button className="btn btn-sm btn-default btn-flat pull-right">View All Orders</button>
                </div>
                {/* /.box-footer */}
              </div>
              {/* /.col */}
