...
async function bannerFiction() {
  ...
  if (bannersQuantity === 0) {
    ...
    // Create Banner HTML 4
    await Banner.create({
      name: 'Banner Top 1160x90',
      html: `<script>(function(){admid='abc',__admLink='http://dantri.com.vn';function admGetUrlCk(){return '';}var doc=document,url=encodeURIComponent(__admLink),ua=navigator.userAgent+'';var videourl='http://adi.admicro.vn/adt/banners/nam2015/4043/min_html5/2016_12_19/1482082168918/skylake/skylake_980_90_left.html';var imageurl='http://adi.admicro.vn/adt/banners/nam2015/4043/min_html5/2016_12_19/1482082168918/skylakeskylake.jpg';var imgwidth=980;var imgheight=90;var html='<div style="position:relative;">'; if(ua.indexOf('Android')!=-1 || ua.indexOf('iPad')!=-1 || ua.indexOf('iPhone')!=-1){html+=('<img src="' + imageurl + '" border="0" /><a href="' + url + '" target="_blank" style="position:absolute; top:0; left:0; width:' + imgwidth + 'px; height:' + imgheight + 'px; display:block;z-index:9999;"><span></span></a>')}else{html+=('<iframe src="' + videourl + '?url=' + (encodeURIComponent(url)) + '&admid=' + admid + '" width="' + imgwidth + '" frameborder="0" scrolling="no" height="' + imgheight + '" ></iframe>')}html+='</div>';doc.write(html);})();</script>`,
      status: STATUS_ACTIVE,
      width: 980,
      height: 90,
      keyword: 'iPhone, Android, iPad',
