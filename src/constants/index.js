...
export const GET_OPTION_CHANNEL = 'GET_OPTION_CHANNEL';
...
export const GET_CLICK_IMPRESSION = 'GET_CLICK_IMPRESSION';
export const GET_CLICK_IMPRESSIONS = 'GET_CLICK_IMPRESSIONS';
export const CREATE_CLICK_IMPRESSION = 'CREATE_CLICK_IMPRESSION';
export const UPDATE_CLICK_IMPRESSION = 'UPDATE_CLICK_IMPRESSION';
export const DELETE_CLICK_IMPRESSION = 'DELETE_CLICK_IMPRESSION';

export const GET_SHARE_ZONE = 'GET_SHARE_ZONE';
export const GET_SHARE_ZONES = 'GET_SHARE_ZONES';
export const CREATE_SHARE_ZONE = 'CREATE_SHARE_ZONE';
export const UPDATE_SHARE_ZONE = 'UPDATE_SHARE_ZONE';
export const DELETE_SHARE_ZONE = 'DELETE_SHARE_ZONE';
